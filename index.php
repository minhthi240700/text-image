...
$texts = array(
    array("MÃ: 00001", 100, $text_color, 50, 100),
    array("VOUCHER PREP MIỄN PHÍ", 250, $text_color, 100, 300),
    array("HỌ TÊN: HUỲNH MINH THI", 100, $text_color2, 50, 500),
    array("NĂM SINH: 2000", 100, $text_color2, 50, 600),
    array("Vui lòng đưa phiếu voucher cho bộ phận tiếp đón, Mang theo CCCD để sử dụng dịch vụ", 100, $text_color3, 50, 800),
    array("NGUỒN: PREPTHANHTRI", 100, $text_color4, 50, 1000)
);


// Vẽ từng mẩu văn bản lên ảnh mới
foreach ($texts as $text_data) {
    list($text, $font_size, $color, $x, $y) = $text_data;
